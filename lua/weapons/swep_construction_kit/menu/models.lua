...
local function CreatePositionModifiers(data, panel)
    ...
    mxwang.Wang.ConVarChanged = function(p, value)
        data.pos.x = tonumber(value)
    end
    ...
    mywang.Wang.ConVarChanged = function(p, value)
        data.pos.y = tonumber(value)
    end
    ...
    mzwang.Wang.ConVarChanged = function(p, value)
        data.pos.z = tonumber(value)
    end
...
local function CreateAngleModifiers(data, panel)
    ...
    mpitchwang.Wang.ConVarChanged = function(p, value)
        data.angle.p = tonumber(value)
    end
    ...
    myawwang.Wang.ConVarChanged = function(p, value)
        data.angle.y = tonumber(value)
    end
    ...
    mrollwang.Wang.ConVarChanged = function(p, value)
        data.angle.r = tonumber(value)
    end
...
local function CreateSizeModifiers(data, panel, dimensions)
    ...
    if dimensions > 1 then
        ...
        msywang.Wang.ConVarChanged = function(p, value)
            data.size.y = tonumber(value)
        end
        ...
        if dimensions > 2 then
            ...
            mszwang.Wang.ConVarChanged = function(p, value)
                data.size.z = tonumber(value)
            end
...
local function CreateColorModifiers(data, panel)
    ...
    colrwang.Wang.ConVarChanged = function(p, value)
        data.color.r = tonumber(value)
    end
    ...
    colgwang.Wang.ConVarChanged = function(p, value)
        data.color.g = tonumber(value)
    end
    ...
    colbwang.Wang.ConVarChanged = function(p, value)
        data.color.b = tonumber(value)
    end
    ...
    colawang.Wang.ConVarChanged = function(p, value)
        data.color.a = tonumber(value)
    end
...
local function CreateModelModifier(data, panel)
    ...
    wtbtn.DoClick = function()
        wep:OpenBrowser(data.model, "model", function(val)
            pmmtext:SetText(val)
            pmmtext:OnTextChanged()
        end)
    end
...
local function CreateSpriteModifier(data, panel)
    ...
    wtbtn.DoClick = function()
        wep:OpenBrowser(data.sprite, "material", function(val)
            pmmtext:SetText(val)
            pmmtext:OnTextChanged()
        end)
    end
...
local function CreateMaterialModifier(data, panel)
    ...
    wtbtn.DoClick = function()
        wep:OpenBrowser(data.material, "material", function(val)
            mattext:SetText(val)
            mattext:OnTextChanged()
        end)
    end
...
local function CreateBodygroupSkinModifier(data, panel)
    ...
    skwang.ConVarChanged = function(p, value)
...
local function CreateModelPanel(name, preset_data)
    ...
    panellist.Paint = function()
        ...
        surface.DrawRect(0, 0, panellist:GetWide(), panellist:GetTall())
    end
...
mnbtn.DoClick = function()
    ...
    if new then
        if new == "" then
            CreateNote("Empty name field!")

            return
        end

        if wep.v_models[new] ~= nil then
            CreateNote("Name already exists!")
...
mnwbtn.DoClick = function()
    ...
    if new then
        if new == "" then
            CreateWNote("Empty name field!")

            return
        end

        if wep.w_models[new] ~= nil then
            CreateWNote("Name already exists!")
